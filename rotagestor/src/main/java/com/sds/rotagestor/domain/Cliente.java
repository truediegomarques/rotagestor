...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByCredito", query = "SELECT c FROM Cliente c WHERE c.credito = :credito"),
    ...
    @NamedQuery(name = "Cliente.findByAutorizado", query = "SELECT c FROM Cliente c WHERE c.autorizado = :autorizado"),
    ...
    @NamedQuery(name = "Cliente.findByRef1", query = "SELECT c FROM Cliente c WHERE c.ref1 = :ref1"),
    @NamedQuery(name = "Cliente.findByFone1", query = "SELECT c FROM Cliente c WHERE c.fone1 = :fone1"),
    @NamedQuery(name = "Cliente.findByRef2", query = "SELECT c FROM Cliente c WHERE c.ref2 = :ref2"),
    @NamedQuery(name = "Cliente.findByFone2", query = "SELECT c FROM Cliente c WHERE c.fone2 = :fone2"),
    @NamedQuery(name = "Cliente.findByRef3", query = "SELECT c FROM Cliente c WHERE c.ref3 = :ref3"),
    @NamedQuery(name = "Cliente.findByFone3", query = "SELECT c FROM Cliente c WHERE c.fone3 = :fone3"),
    @NamedQuery(name = "Cliente.findByEstCivil", query = "SELECT c FROM Cliente c WHERE c.estCivil = :estCivil"),
    @NamedQuery(name = "Cliente.findByConjuge", query = "SELECT c FROM Cliente c WHERE c.conjuge = :conjuge"),
    @NamedQuery(name = "Cliente.findByFiliacao", query = "SELECT c FROM Cliente c WHERE c.filiacao = :filiacao"),
    @NamedQuery(name = "Cliente.findByEtiqueta", query = "SELECT c FROM Cliente c WHERE c.etiqueta = :etiqueta"),
    @NamedQuery(name = "Cliente.findByRfpessoal1", query = "SELECT c FROM Cliente c WHERE c.rfpessoal1 = :rfpessoal1"),
    @NamedQuery(name = "Cliente.findByRfpessoal2", query = "SELECT c FROM Cliente c WHERE c.rfpessoal2 = :rfpessoal2"),
    @NamedQuery(name = "Cliente.findByParente1", query = "SELECT c FROM Cliente c WHERE c.parente1 = :parente1"),
    @NamedQuery(name = "Cliente.findByParente2", query = "SELECT c FROM Cliente c WHERE c.parente2 = :parente2"),
    @NamedQuery(name = "Cliente.findByTelref1", query = "SELECT c FROM Cliente c WHERE c.telref1 = :telref1"),
    @NamedQuery(name = "Cliente.findByTelref2", query = "SELECT c FROM Cliente c WHERE c.telref2 = :telref2"),
    @NamedQuery(name = "Cliente.findByOrgao", query = "SELECT c FROM Cliente c WHERE c.orgao = :orgao"),
    @NamedQuery(name = "Cliente.findByNomeBanco", query = "SELECT c FROM Cliente c WHERE c.nomeBanco = :nomeBanco"),
    @NamedQuery(name = "Cliente.findByNumBanco", query = "SELECT c FROM Cliente c WHERE c.numBanco = :numBanco"),
    ...
    @NamedQuery(name = "Cliente.findByDtAbertura", query = "SELECT c FROM Cliente c WHERE c.dtAbertura = :dtAbertura"),
    @NamedQuery(name = "Cliente.findBySpc", query = "SELECT c FROM Cliente c WHERE c.spc = :spc"),
    @NamedQuery(name = "Cliente.findByAdvogado", query = "SELECT c FROM Cliente c WHERE c.advogado = :advogado"),
    @NamedQuery(name = "Cliente.findByUsado", query = "SELECT c FROM Cliente c WHERE c.usado = :usado"),
    @NamedQuery(name = "Cliente.findByTipoend", query = "SELECT c FROM Cliente c WHERE c.tipoend = :tipoend"),
    ...
    @NamedQuery(name = "Cliente.findByCodmunicipio", query = "SELECT c FROM Cliente c WHERE c.codmunicipio = :codmunicipio"),
    @NamedQuery(name = "Cliente.findByEmpresaConvenio", query = "SELECT c FROM Cliente c WHERE c.empresaConvenio = :empresaConvenio"),
    @NamedQuery(name = "Cliente.findByLimiteCh", query = "SELECT c FROM Cliente c WHERE c.limiteCh = :limiteCh"),
    @NamedQuery(name = "Cliente.findByCreditoCh", query = "SELECT c FROM Cliente c WHERE c.creditoCh = :creditoCh"),
    @NamedQuery(name = "Cliente.findByUsadoCh", query = "SELECT c FROM Cliente c WHERE c.usadoCh = :usadoCh"),
    @NamedQuery(name = "Cliente.findByCarencia", query = "SELECT c FROM Cliente c WHERE c.carencia = :carencia"),
    @NamedQuery(name = "Cliente.findByTipofidelidade", query = "SELECT c FROM Cliente c WHERE c.tipofidelidade = :tipofidelidade"),
    @NamedQuery(name = "Cliente.findByPontuacao", query = "SELECT c FROM Cliente c WHERE c.pontuacao = :pontuacao"),
    @NamedQuery(name = "Cliente.findByLoja", query = "SELECT c FROM Cliente c WHERE c.loja = :loja"),
    @NamedQuery(name = "Cliente.findByTabelapreco", query = "SELECT c FROM Cliente c WHERE c.tabelapreco = :tabelapreco"),
    @NamedQuery(name = "Cliente.findByIdtipocliente", query = "SELECT c FROM Cliente c WHERE c.idtipocliente = :idtipocliente"),
    @NamedQuery(name = "Cliente.findByFinalizadoras", query = "SELECT c FROM Cliente c WHERE c.finalizadoras = :finalizadoras"),
    @NamedQuery(name = "Cliente.findByEmail", query = "SELECT c FROM Cliente c WHERE c.email = :email"),
    @NamedQuery(name = "Cliente.findByFantasia", query = "SELECT c FROM Cliente c WHERE c.fantasia = :fantasia"),
    @NamedQuery(name = "Cliente.findByVencimento", query = "SELECT c FROM Cliente c WHERE c.vencimento = :vencimento"),
    @NamedQuery(name = "Cliente.findByNumerocartao", query = "SELECT c FROM Cliente c WHERE c.numerocartao = :numerocartao"),
    @NamedQuery(name = "Cliente.findBySenhacartao", query = "SELECT c FROM Cliente c WHERE c.senhacartao = :senhacartao"),
    @NamedQuery(name = "Cliente.findByNomeEntrega", query = "SELECT c FROM Cliente c WHERE c.nomeEntrega = :nomeEntrega"),
    @NamedQuery(name = "Cliente.findByTipoEndEntrega", query = "SELECT c FROM Cliente c WHERE c.tipoEndEntrega = :tipoEndEntrega"),
    @NamedQuery(name = "Cliente.findByEnderecoEntrega", query = "SELECT c FROM Cliente c WHERE c.enderecoEntrega = :enderecoEntrega"),
    @NamedQuery(name = "Cliente.findByNumeroEntrega", query = "SELECT c FROM Cliente c WHERE c.numeroEntrega = :numeroEntrega"),
    @NamedQuery(name = "Cliente.findByCepEntrega", query = "SELECT c FROM Cliente c WHERE c.cepEntrega = :cepEntrega"),
    @NamedQuery(name = "Cliente.findByBairroEntrega", query = "SELECT c FROM Cliente c WHERE c.bairroEntrega = :bairroEntrega"),
    @NamedQuery(name = "Cliente.findByCidadeentrega", query = "SELECT c FROM Cliente c WHERE c.cidadeentrega = :cidadeentrega"),
    @NamedQuery(name = "Cliente.findByUfentrega", query = "SELECT c FROM Cliente c WHERE c.ufentrega = :ufentrega"),
    @NamedQuery(name = "Cliente.findByNomecob", query = "SELECT c FROM Cliente c WHERE c.nomecob = :nomecob"),
    @NamedQuery(name = "Cliente.findByTipoendcob", query = "SELECT c FROM Cliente c WHERE c.tipoendcob = :tipoendcob"),
    @NamedQuery(name = "Cliente.findByEnderecocob", query = "SELECT c FROM Cliente c WHERE c.enderecocob = :enderecocob"),
    @NamedQuery(name = "Cliente.findByNumerocob", query = "SELECT c FROM Cliente c WHERE c.numerocob = :numerocob"),
    ...
    @NamedQuery(name = "Cliente.findByCidadecob", query = "SELECT c FROM Cliente c WHERE c.cidadecob = :cidadecob"),
    ...
    @NamedQuery(name = "Cliente.findByMensagem", query = "SELECT c FROM Cliente c WHERE c.mensagem = :mensagem"),
    @NamedQuery(name = "Cliente.findByDiasCalcVencConvenio", query = "SELECT c FROM Cliente c WHERE c.diasCalcVencConvenio = :diasCalcVencConvenio"),
    @NamedQuery(name = "Cliente.findByCondicaoCalcVencimento", query = "SELECT c FROM Cliente c WHERE c.condicaoCalcVencimento = :condicaoCalcVencimento"),
    @NamedQuery(name = "Cliente.findByMelhordiacompra", query = "SELECT c FROM Cliente c WHERE c.melhordiacompra = :melhordiacompra"),
    @NamedQuery(name = "Cliente.findBySegundaPessoaAutorizada", query = "SELECT c FROM Cliente c WHERE c.segundaPessoaAutorizada = :segundaPessoaAutorizada"),
    @NamedQuery(name = "Cliente.findByOpsn", query = "SELECT c FROM Cliente c WHERE c.opsn = :opsn"),
    @NamedQuery(name = "Cliente.findByComplementoEntrega", query = "SELECT c FROM Cliente c WHERE c.complementoEntrega = :complementoEntrega"),
    @NamedQuery(name = "Cliente.findByComplementoCob", query = "SELECT c FROM Cliente c WHERE c.complementoCob = :complementoCob"),
    @NamedQuery(name = "Cliente.findByMatricula", query = "SELECT c FROM Cliente c WHERE c.matricula = :matricula"),
    @NamedQuery(name = "Cliente.findByStatusCadastro", query = "SELECT c FROM Cliente c WHERE c.statusCadastro = :statusCadastro"),
    @NamedQuery(name = "Cliente.findByAtivaDescontoIcmsNf", query = "SELECT c FROM Cliente c WHERE c.ativaDescontoIcmsNf = :ativaDescontoIcmsNf"),
    ...
    @NamedQuery(name = "Cliente.findByDesconto", query = "SELECT c FROM Cliente c WHERE c.desconto = :desconto"),
    @NamedQuery(name = "Cliente.findByDescontoProdutoPromocao", query = "SELECT c FROM Cliente c WHERE c.descontoProdutoPromocao = :descontoProdutoPromocao"),
    @NamedQuery(name = "Cliente.findByDescontoGeral", query = "SELECT c FROM Cliente c WHERE c.descontoGeral = :descontoGeral"),
    @NamedQuery(name = "Cliente.findByCondicaoPagamento", query = "SELECT c FROM Cliente c WHERE c.condicaoPagamento = :condicaoPagamento"),
    @NamedQuery(name = "Cliente.findByMelhorHoraEntrega", query = "SELECT c FROM Cliente c WHERE c.melhorHoraEntrega = :melhorHoraEntrega"),
    @NamedQuery(name = "Cliente.findByControlaLimiteClientePorcentagem", query = "SELECT c FROM Cliente c WHERE c.controlaLimiteClientePorcentagem = :controlaLimiteClientePorcentagem"),
    @NamedQuery(name = "Cliente.findByLimiteLiberarAcimaPercentual", query = "SELECT c FROM Cliente c WHERE c.limiteLiberarAcimaPercentual = :limiteLiberarAcimaPercentual"),
    @NamedQuery(name = "Cliente.findByCUF", query = "SELECT c FROM Cliente c WHERE c.cUF = :cUF"),
    @NamedQuery(name = "Cliente.findByPaisIbge", query = "SELECT c FROM Cliente c WHERE c.paisIbge = :paisIbge"),
    @NamedQuery(name = "Cliente.findByExtrangeiro", query = "SELECT c FROM Cliente c WHERE c.extrangeiro = :extrangeiro"),
    @NamedQuery(name = "Cliente.findByVendedorID", query = "SELECT c FROM Cliente c WHERE c.vendedorID = :vendedorID"),
    @NamedQuery(name = "Cliente.findByUsuarioAlteracao", query = "SELECT c FROM Cliente c WHERE c.usuarioAlteracao = :usuarioAlteracao"),
    @NamedQuery(name = "Cliente.findByUltimaAlteracao", query = "SELECT c FROM Cliente c WHERE c.ultimaAlteracao = :ultimaAlteracao")})
